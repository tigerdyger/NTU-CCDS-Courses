...
\exercisegroup{SC3000-TUT02}{Tutorial 02：CSP 与 Game Playing}
...
\begin{figure}[htbp]
  \centering
  \resizebox{0.98\textwidth}{!}{\input{figures/tutorial02-csp-search-profile}}
...
\begin{figure}[htbp]
  \centering
  \resizebox{0.98\textwidth}{!}{\input{figures/tutorial02-tictactoe-minimax}}

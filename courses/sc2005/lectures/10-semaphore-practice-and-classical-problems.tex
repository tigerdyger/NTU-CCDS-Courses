...
\begin{figure}[htbp]
  \centering
  \resizebox{0.96\textwidth}{!}{\input{figures/bounded-buffer-semaphore-flow}}
...
\begin{figure}[htbp]
  \centering
  \input{figures/dining-philosophers-cycle}
...
\begin{itemize}
  \item 最多允许四位 philosophers 同时参与取 chopsticks。若假设参与者全部阻塞，则每人至多持一根，必有空闲 chopstick，五人等待环无法闭合；拿齐两根者能够吃饭并释放资源。

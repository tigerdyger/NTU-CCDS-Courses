...
\clearpage
\exercisegroup{SC2005-TUT03}{Tutorial 03：CPU Scheduling}
...
\begin{figure}[htbp]
  \centering
  \resizebox{0.98\textwidth}{!}{\input{figures/tutorial03-q2-schedules}}
...
\begin{figure}[htbp]
  \centering
  \resizebox{0.92\textwidth}{!}{\input{figures/tutorial03-q3-given-schedule}}

...
\exercisegroup{SC4001-TUT03}{Tutorial 03：Neuron Layers、Regression Pipeline 与 Mini-batch Training}
...
\begin{figure}[htbp]
  \centering
  \resizebox{0.98\textwidth}{!}{\input{figures/tutorial-03-data-training-pipeline}}

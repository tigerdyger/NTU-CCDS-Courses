...
\exercisegroup{SC4001-TUT01}{Tutorial 01：Perceptron、Forward Propagation 与 Decision Region}
...
\begin{figure}[htbp]
  \centering
  \resizebox{0.78\textwidth}{!}{\input{figures/tutorial-01-weight-space}}
...
\begin{figure}[htbp]
  \centering
  \resizebox{0.78\textwidth}{!}{\input{figures/tutorial-01-input-region}}

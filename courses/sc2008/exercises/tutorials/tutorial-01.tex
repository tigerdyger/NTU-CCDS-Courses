...
\exercisegroup{SC2008-TUT01}{Tutorial 01：Layering、Encapsulation 与 Network Resilience}
...
\begin{figure}[htbp]
  \centering
  \resizebox{\textwidth}{!}{\input{figures/encapsulation}}
...
\begin{figure}[htbp]
  \centering
  \resizebox{0.78\textwidth}{!}{\input{figures/tutorial01-resilience-topology}}
